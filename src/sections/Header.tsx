            ...
            <div className="my-container">
                <div className="flex justify-between items-center h-24 md:h-28">
                    ...
                    <div className="flex gap-4 items-center">
                        <button className="relative hidden md:inline-block bg-fuchsia-500/20 px-4 py-2 font-extrabold uppercase font-heading text-sm tracking-wide">
                        ...
                        <div className="size-10 relative">
                            ...
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                                <div className="w-5 h-0.5 bg-zinc-300 translate-y-1 text-[5.5rem]"></div>
                            </div>
                        </div>
                    </div>
                </div>
