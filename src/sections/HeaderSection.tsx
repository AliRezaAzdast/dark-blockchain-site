...
function HeaderSection() {
    ...
    return (
        <>
                ...
                <div className="my-container">
                    <div className="flex justify-between items-center h-24 md:h-28">
                        ...
                        <div className="flex gap-4 items-center">
                            <CutCornerButton children={'Get Started'} className={'hidden md:inline-block'} />
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div className="fixed size-full top-0 left-0 z-30 bg-zinc-900" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: .5 }}>
                                ...
                                <nav className="flex flex-col items-center gap-12 md:gap-16">
                                    {navLinks.map((link, index) => (
                                        <motion.a
                                            ...
                                            transition={{ duration: .5, ease: 'linear', delay: .25 * index }}
                                        >
