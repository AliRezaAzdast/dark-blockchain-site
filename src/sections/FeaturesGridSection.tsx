...
const listItems = [
  ...
  'unlock the potenial of decentralized network'
]
        ...
        <div className="flex flex-col gap-56 md:gap-48 lg:gap-80">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-xl lg:text-2xl text-zinc-400 mt-8">Blockforge provide robust and secure  to support the next generation of decentralized applications.</p>
              <ul className="flex flex-col gap-8 mt-12">
                {listItems.map(item => (
                  <li key={item} className="flex items-center gap-3">
                    <div className="inline-flex flex-shrink-0 justify-center items-center size-8 outline-4 -outline-offset-4 outline-fuchsia-400/10 rounded-full">
              ...
              <div className="flex gap-8 mt-12">
                ...
                <TextButton color="">Learn More</TextButton>
              </div>
            </div>
