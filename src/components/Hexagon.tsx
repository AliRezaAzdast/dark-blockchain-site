...
function Hexagon(props: ComponentPropsWithoutRef<'svg'> & { size?: number, reverse?: boolean, speed?: number }) {
    const { className, size = 800, reverse = false, speed = 10 } = props
    ...
    return (
        <div className="inline-flex relative">
            <svg width="82" height="72" style={{
                height: size,
                width: size
            }} className={twMerge('text-fuchsia-500/10 -rotate-6', className)} viewBox="0 0 82 72" fill="none" stroke="currentColor" strokeWidth="6" xmlns="http://www.w3.org/2000/svg">
            ...
            {totalPathLength && (
                <motion.svg width="82" height="72"
                    ...
                    className={twMerge('text-fuchsia-500/30 -rotate-6 absolute', className)} viewBox="0 0 82 72" fill="none" stroke="currentColor" strokeWidth="6" xmlns="http://www.w3.org/2000/svg">
