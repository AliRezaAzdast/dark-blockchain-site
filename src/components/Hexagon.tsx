...
function Hexagon(props: ComponentPropsWithoutRef<'svg'>) {
    const {className} = props
    return (
        <svg width="82" height="72" className={twMerge('text-fuchsia-500/10 -rotate-6', className )} viewBox="0 0 82 72" fill="none" stroke="currentColor" strokeWidth="6" xmlns="http://www.w3.org/2000/svg">
